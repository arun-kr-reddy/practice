...
void
edgeX (pgm_t &src_img, pgm_t &dst_img, edge_e edge)
{
    convolve (src_img, dst_img, sobel_x_kernel, 3, sobel_div_factor, edge);
}

void
edgeY (pgm_t &src_img, pgm_t &dst_img, edge_e edge)
{
    convolve (src_img, dst_img, sobel_y_kernel, 3, sobel_div_factor, edge);
}

void
edgeRms (pgm_t &edgeX_img, pgm_t &edgeY_img, pgm_t &dst_img, uint8_t threshold)
{
